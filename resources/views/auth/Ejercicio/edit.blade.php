...
@section('contenido')
    ...
    @method('put')
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <label for="descripcion_Ejercicio" class="form-label">Descripcion</label><br>
                <input type="text" name="descripcion_Ejercicio" class="form-control" id="descripcion_Ejercicio" value="{{ old('descripcion_Ejercicio', $ejercicio->descripcion_Ejercicio) }}"><br>
            </div>
