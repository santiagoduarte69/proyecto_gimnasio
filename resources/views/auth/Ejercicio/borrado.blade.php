...
<head>
    ...
    <title>Ejercicio Eliminado</title>
</head>
...
<body>
    <section class="modal">
        <div class="modal-container">
            ...
            <p class="paragraph">El Ejercicio fue eliminado correctamente, ¿deseas eliminar otro ejercicio?</p>
            <div class="btns">
    ...
    <script>
        Swal.fire({
            title: '<strong>Ejercicio Eliminado</strong>',
            icon: 'success',
            backdrop: true,
            timer: 5000,
