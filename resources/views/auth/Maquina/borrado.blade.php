...
<body>
    <section class="modal">
        <div class="modal-container">
            ...
            <p class="paragraph">La maquina fue eliminada correctamente, ¿deseas eliminar otra maquina?</p>
            <div class="btns">
    ...
    <script>
        Swal.fire({
            title: '<strong>Maquina Eliminada</strong>',
            icon: 'success',
            backdrop: true,
            timer: 5000,
