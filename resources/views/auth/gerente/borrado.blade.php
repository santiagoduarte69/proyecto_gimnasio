...
<body>
    <section class="modal">
        <div class="modal-container">
            ...
            <p class="paragraph">La Gerente fue eliminado correctamente, ¿deseas eliminar otro Gerente?</p>
            <div class="btns">
    ...
    <script>
        Swal.fire({
            title: '<strong>Gerente Eliminado</strong>',
            icon: 'success',
            backdrop: true,
            timer: 5000,
