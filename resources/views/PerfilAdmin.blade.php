    ...
    <div class="wrapper">
        ...
        <div class="form">
            <div class="inputfield">
                <label>Nombre</label>
                <input type="text" class="input" disabled placeholder="Pedro">
            </div>
            <div class="inputfield">
                <label>Apellido</label>
                <input type="text" class="input" disabled placeholder="Martinez">
            </div>
            <div class="inputfield">
                <label>Fecha Nacimiento</label>
                <input type="text" class="input" disabled placeholder="01/12/2000">
            </div>
            <div class="inputfield">
