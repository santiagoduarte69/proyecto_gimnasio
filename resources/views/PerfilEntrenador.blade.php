    ...
    <div class="wrapper">
        ...
        <div class="form">
            <div class="inputfield">
                <label>Nombre</label>
                <input type="text" class="input" readonly placeholder="Yohan Santiago">
            </div>
            <div class="inputfield">
                <label>Apellido</label>
                <input type="text" class="input" readonly placeholder="Duarte Martinez">
            </div>
            <div class="inputfield">
                <label>Fecha Nacimiento</label>
                <input type="text" class="input" readonly placeholder="01/12/2005">
            </div>
            <div class="inputfield">
